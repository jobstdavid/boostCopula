#' Density of a Conditional Bivariate Copula
#'
#' Probability density function (PDF) of an \code{boostBiCop} object.
#'
...
#' @param ... unused.
#'
#' @return A numeric vector containing the density values of the considered \code{boostBiCop} object, evaluated at \code{U} and \code{X}.
#'
...
boostBiCopPDF <- function(object, U, X, ...) {
